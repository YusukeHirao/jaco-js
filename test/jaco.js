...
describe('Jaco Class', () => {
	...
	it('英数字を半角に変換', () => {
		...
		a.toNarrowAlphanumeric().toString().should.equal(b);
	});
	...
	it('記号を半角に変換', () => {
		...
		a.toNarrowSign().toString().should.equal(b);
	});
	...
	it('英数字を全角に変換', () => {
		...
		a.toWideAlphanumeric().toString().should.equal(b);
	});
	...
	it('記号を全角に変換', () => {
		...
		a.toWideSign().toString().should.equal(b);
	});
