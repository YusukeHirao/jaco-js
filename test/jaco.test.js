...
test('連結', (t) => {
	const a = new Jaco('あ');
	t.is(a.concat('い', new Jaco('う'), 'え', new Jaco('お'), ['か', new Jaco('き')]).toString(), 'あいうえおかき');
});

// convertIterationMarks()
test('繰り返し記号変換', (t) => {
	t.is(new Jaco('がくもんのすゝめ').convertIterationMarks().toString(), 'がくもんのすすめ');
});

// convertIterationMarks()
test('繰り返し記号変換2', (t) => {
	t.is(new Jaco('がくもんのすゝゝゝゝゝゝゝゝゝゝゝゝめ').convertIterationMarks().toString(), 'がくもんのすすすすすすすすすすすすすめ');
});

// convertIterationMarks()
test('繰り返し記号変換3', (t) => {
	t.is(new Jaco('がくもんのすゝゝゝゞゝゝゝゝゝゝゝゝゝめ').convertIterationMarks().toString(), 'がくもんのすすすすずすすすすすすすすすめ');
});
...
// convertProlongedSoundMarks()
test('長音符変換2', (t) => {
	t.is(new Jaco('ウバッシャアーーーーーーーーー').convertProlongedSoundMarks().toString(), 'ウバッシャアアアアアアアアアア');
});
...
test('不完全サロゲートペアの削除', (t) => {
	t.is(new Jaco('𩸽のひらき').removeUnpairedSurrogate().toString(), '𩸽のひらき');
});

// removeUnpairedSurrogate
test('不完全サロゲートペアの削除2', (t) => {
	t.is(new Jaco('𩸽𩸽𩸽𩸽𩸽').removeUnpairedSurrogate().toString(), '𩸽𩸽𩸽𩸽𩸽');
});

// removeUnpairedSurrogate
test('不完全サロゲートペアの削除3', (t) => {
	t.is(new Jaco('\ude3d\ud867\ude3d\ud867\ude3d\ud867').removeUnpairedSurrogate().toString(), '𩸽𩸽');
});

// removeUnpairedSurrogate
test('不完全サロゲートペアの削除4', (t) => {
	t.is(new Jaco('ほっけのひらき').removeUnpairedSurrogate().toString(), 'ほっけのひらき');
});

// removeUnpairedSurrogate
test('不完全サロゲートペアの削除5', (t) => {
	t.is(new Jaco(`${START_HIGH}ほっけのひらき`).removeUnpairedSurrogate().toString(), 'ほっけのひらき');
});

// removeUnpairedSurrogate
test('不完全サロゲートペアの削除6', (t) => {
	t.is(new Jaco(`ほっけのひらき${END_LOW}`).removeUnpairedSurrogate().toString(), 'ほっけのひらき');
});
...
test('不完全サロゲートペアの削除9', (t) => {
	t.is(new Jaco('ほっけ\ud867のひらき').removeUnpairedSurrogate().toString(), 'ほっけのひらき');
});
...
test('不完全サロゲートペアの削除11', (t) => {
	t.is(new Jaco('𩸽\ude3dのひらき').removeUnpairedSurrogate().toString(), '𩸽のひらき');
});
...
test('不完全サロゲートペアの削除15', (t) => {
	t.is(new Jaco('ひらきにする𩸽\ud867').removeUnpairedSurrogate().toString(), 'ひらきにする𩸽');
});
...
test('不完全サロゲートペアの削除17', (t) => {
	t.is(new Jaco('ひらきにする\ud867𩸽').removeUnpairedSurrogate().toString(), 'ひらきにする𩸽');
});
...
test('置換', (t) => {
	...
	t.is(a.replace(/abc/ig, 'z').toString(), 'zdezDE');
});
