    ...
    var Jaco = (function () {
        ...
        */
        Jaco.prototype.isNumeric = function (negative, floatingPoint) {
            if (typeof negative === "undefined") { negative = true; }
            if (typeof floatingPoint === "undefined") { floatingPoint = true; }
            var pattern = '^';
            if (negative) {
                pattern += '-?';
            }
        ...
        */
        Jaco.prototype.toNumeric = function (negative, floatingPoint) {
            ...
            if (typeof floatingPoint === "undefined") { floatingPoint = false; }
            // 半角化
            this.toNarrow();
        ...
        */
        Jaco.prototype.toNarrowKatakana = function (fromHiragana) {
            if (typeof fromHiragana === "undefined") { fromHiragana = false; }
            // ひらがなを一旦全角カタカナに変換する
            if (fromHiragana) {
                this.toKatakana();
            }
        ...
        */
        Jaco.prototype.toNarrow = function (convertJapaneseChars) {
            if (typeof convertJapaneseChars === "undefined") { convertJapaneseChars = false; }
            // スペースの変換
