...
(function (jaco) {
    ...
    */
    function naturalKanaOrder(a, b) {
        var _a = new jaco.Jaco(a).toStringForNaturalKanaOrder();
        var _b = new jaco.Jaco(b).toStringForNaturalKanaOrder();
        if (_a < _b) {
            return -1;
        }
        else if (_a > _b) {
...
(function (jaco) {
    ...
    */
    var Jaco = (function () {
        ...
        * @return インスタンス自信
        */
        Jaco.prototype.removeVoicedMarks = function () {
            // 濁点・半濁点単体の除去
            this.remove(/\u309B|\u3099|\uFF9E/g);
            this.remove(/\u309C|\u309A|\uFF9F/g);
            return this._replaceMap({
        ...
        */
        Jaco.prototype.convertIterationMarks = function () {
            var kanaWithIterationMarks = new RegExp('([' + jaco.HIRAGANA_CHARS_IGNORE_ITERATION_MARKS + jaco.KATAKANA_CHARS_IGNORE_ITERATION_MARKS + '])([ゝヽゞヾ])');
            var conv = function (_str) {
        ...
        * @return 擬似的に入れ替えた文字列
        */
        Jaco.prototype.toStringForNaturalKanaOrder = function () {
            // 濁点半濁点を取り除いてひらがな化
            var psuedo = this.clone().removeVoicedMarks().toHiragana().convertProlongedSoundMarks().convertIterationMarks();
