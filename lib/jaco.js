...
class Jaco {
     ...
     */
    get length() {
        const array = arrayize_1.default(this.$);
        return array.length;
    }
    /**
     * 半濁点を追加する
     ...
     */
    addSemivoicedMarks() {
        let newStr = addSemivoicedMarks_1.default(this.$);
     ...
     */
    addVoicedMarks() {
        let newStr = addVoicedMarks_1.default(this.$);
        return new Jaco(newStr);
    }
    /**
     * 後方結合
     ...
     *
     */
    lastIndexOf(str, fromIndex = Infinity) {
    ...
    padEnd(targetLength, padString = ' ') {
        const thisArray = arrayize_1.default(this.$);
